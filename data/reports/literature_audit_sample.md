# Literature Audit Sample

- Seed: `20260517`
- Sample size: `40`
- Current false positive ratio: `0.00%`
- Removed false positives in risk sample: `2`

| Stratum | Verdict | Venue | Year | Title | Notes |
| --- | --- | --- | --- | --- | --- |
| risk | true_positive_core | SIGMOD | 2023 | Few-shot Text-to-SQL Translation using Structure and Content Prompt Learning | missing doi, abstract; risk-directed sample |
| risk | true_positive_core | WWW | 2026 | SQL-Checker: Error Detection and Labeling for Text-to-SQL with Interpretability Analysis | missing doi, abstract; risk-directed sample |
| risk | false_positive_removed | TSE | 2025 | CoSQA <sup>+</sup> : Enhancing Code Search Evaluation With a Multi-Choice Benchmark and Test-Driven Agents | removed by prune-irrelevant; risk-directed sample |
...
| ccf_conference | true_positive_core | NeurIPS | 2022 | EHRSQL: A Practical Text-to-SQL Benchmark for Electronic Health Records | missing doi |
| ccf_conference | true_positive_application | SIGMOD | 2023 | Demonstration of ThalamusDB: Answering Complex SQL Queries with Natural Language Predicates on Multi-Modal Data |  |
| ccf_conference | true_positive_core | NeurIPS | 2025 | SQL-R1: Training Natural Language to SQL Reasoning Model By Reinforcement Learning | missing doi |
| ccf_conference | true_positive_application | SIGMOD | 2022 | Sevi: Speech-to-Visualization through Neural Machine Translation |  |
| ccf_conference | true_positive_core | AAAI | 2020 | Neural Semantic Parsing in Low-Resource Settings with Back-Translation and Meta-Learning |  |
| ccf_conference | true_positive_core | ACL | 2025 | Uncovering the Impact of Chain-of-Thought Reasoning for Direct Preference Optimization: Lessons from Text-to-SQL | missing doi, abstract |
...
| ccf_conference | true_positive_core | VLDB | 2023 | CatSQL: Towards Real World Natural Language to SQL Applications | missing doi |
...
| readme_journal | true_positive_core | VLDBJ | 2023 | xDBTagger: explainable natural language interface to databases using keyword mappings and schema graph |  |
| arxiv | true_positive_core | ArXiv | 2025 | LLMSQL: Upgrading WikiSQL for the LLM Era of Text-to-SQL | missing doi |
...
| arxiv | true_positive_core | ArXiv | 2025 | Agentic LLMs for Question Answering over Tabular Data | missing doi |
| arxiv | true_positive_core | ArXiv | 2023 | SPSQL: Step-by-step Parsing Based Framework for Text-to-SQL Generation | missing doi |
| arxiv | true_positive_core | ArXiv | 2025 | Datrics Text2SQL: A Framework for Natural Language to SQL Query Generation | missing doi |
...
| fill | true_positive_application | VLDB | 2020 | Explaining Natural Language query results |  |
| fill | true_positive_core | SIGMOD | 2026 | Comparison and Analysis of Value Linking in Text-to-SQL systems | missing doi, abstract |
| fill | true_positive_core | ArXiv | 2026 | Sonar-TS: Search-Then-Verify Natural Language Querying for Time Series Databases | missing doi |
| fill | true_positive_core | ArXiv | 2025 | BenchPress: A Human-in-the-Loop Annotation System for Rapid Text-to-SQL Benchmark Curation | missing doi |
